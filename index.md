...
We are Emacs enthusiasts from Slovenia. Our virtual meetings happen every first Saturday at 18:00 CET on [freenode](http://www.freenode.net) [IRC](https://en.wikipedia.org/wiki/Internet_Relay_Chat) network. You can chat with us when connected to /server irc.freenode.net channel [#emacs.si](irc://chat.freenode.net/emacs-berlin)
